  ...
  return (
    <div className="max-w-2xl mx-auto text-center py-12 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link to="/track" className="btn btn-secondary px-8 py-4 flex items-center justify-center gap-2">
          {t('trackOrder')}
        </Link>
        <Link to="/" className="btn btn-primary px-8 py-4 flex items-center justify-center gap-2">
